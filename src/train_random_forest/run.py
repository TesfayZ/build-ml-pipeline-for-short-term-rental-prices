...
def go(args):
    ...
    sk_pipe.fit(X[processed_features], y)
    ...
    # First remove if the same directory exists
    ...
    mlflow.sklearn.save_model(
        ...
        conda_env="conda.yml"  # Specify the conda environment file (optional)
    )
    logger.info("Model saved in MLFlow sklearn format at 'random_forest_dir")
    ...
    # Add the directory containing the exported model files to the artifact
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    # ColumnTransformer instance saved in the `preprocessor` variable, and a step called "random_forest"
    # with the random forest instance saved in the `random_forest` variable.
    sk_pipe = Pipeline([
